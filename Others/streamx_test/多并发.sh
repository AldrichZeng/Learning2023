...
/usr/local/bin/python ${datax_run_scrpit} ${home_dir}/datax.json -p"-DhomeDir=$home_dir -DpgHost=$pgHost -DpgPort=$pgPort -DpgUser=$pgUser -DpgPwd=$pgPwd -DpgDb=$pgDb -Dcount=$COUNT -Dtable=public.test_performance_6" > pre_process6.log 2>&1 &
PID6=$!
# 等待2秒，等待Java进程启动
sleep 2s
...
/usr/local/bin/python ${datax_run_scrpit} ${home_dir}/datax.json -p"-DhomeDir=$home_dir -DpgHost=$pgHost -DpgPort=$pgPort -DpgUser=$pgUser -DpgPwd=$pgPwd -DpgDb=$pgDb -Dcount=$COUNT -Dtable=public.test_performance_7" > pre_process7.log 2>&1 &
PID7=$!
# 等待2秒，等待Java进程启动
sleep 2s
...
/usr/local/bin/python ${datax_run_scrpit} ${home_dir}/datax.json -p"-DhomeDir=$home_dir -DpgHost=$pgHost -DpgPort=$pgPort -DpgUser=$pgUser -DpgPwd=$pgPwd -DpgDb=$pgDb -Dcount=$COUNT -Dtable=public.test_performance_8" > pre_process8.log 2>&1 &
PID8=$!
# 等待2秒，等待Java进程启动
sleep 2s
...
/usr/local/bin/python ${datax_run_scrpit} ${home_dir}/datax.json -p"-DhomeDir=$home_dir -DpgHost=$pgHost -DpgPort=$pgPort -DpgUser=$pgUser -DpgPwd=$pgPwd -DpgDb=$pgDb -Dcount=$COUNT -Dtable=public.test_performance_9" > pre_process9.log 2>&1 &
PID9=$!
# 等待2秒，等待Java进程启动
sleep 2s
...
/usr/local/bin/python ${datax_run_scrpit} ${home_dir}/datax.json -p"-DhomeDir=$home_dir -DpgHost=$pgHost -DpgPort=$pgPort -DpgUser=$pgUser -DpgPwd=$pgPwd -DpgDb=$pgDb -Dcount=$COUNT -Dtable=public.test_performance_10" > pre_process10.log 2>&1 &
PID10=$!
# 等待2秒，等待Java进程启动
sleep 2s
