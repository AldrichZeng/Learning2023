drop table if exists public.test_performance_wide;
create table public.test_performance_wide (
...
create publication di_pub_performance for table public.test_performance_wide;

ALTER TABLE public.test_performance_wide REPLICA IDENTITY FULL;

-- 插入全量数据
insert into public.test_performance_wide (bigint_col) values (111);drop table if exists public.test_performance_wide_1..; 
