drop table if exists public.test_performance_wide_2;
drop table if exists public.test_performance_wide_3;
drop table if exists public.test_performance_wide_4;
drop table if exists public.test_performance_wide_5;
drop table if exists public.test_performance_wide_6;
drop table if exists public.test_performance_wide_7;
drop table if exists public.test_performance_wide_8;
drop table if exists public.test_performance_wide_9;
drop table if exists public.test_performance_wide_10;
drop table if exists public.test_performance_wide_1;
create table public.test_performance_wide_1 (
...
CREATE TABLE public.test_performance_wide_2 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_3 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_4 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_5 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_6 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_7 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_8 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_9 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);

CREATE TABLE public.test_performance_wide_10 (
    LIKE public.test_performance_wide_1 INCLUDING ALL INCLUDING INDEXES
);
...
create publication di_pub_performance for table public.test_performance_wide_1, public.test_performance_wide_2,
public.test_performance_wide_3, public.test_performance_wide_4, public.test_performance_wide_5,
public.test_performance_wide_6, public.test_performance_wide_7, public.test_performance_wide_8,
public.test_performance_wide_9, public.test_performance_wide_10;


ALTER TABLE public.test_performance_wide_1 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_2 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_3 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_4 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_5 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_6 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_7 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_8 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_9 REPLICA IDENTITY FULL;
ALTER TABLE public.test_performance_wide_10 REPLICA IDENTITY FULL;
-- 插入全量数据
insert into public.test_performance_wide_1 (bigint_col )values (111);