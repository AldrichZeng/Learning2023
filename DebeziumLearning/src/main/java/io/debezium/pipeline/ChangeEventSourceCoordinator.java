...
public class ChangeEventSourceCoordinator<P extends Partition, O extends OffsetContext> {
    ...
    protected void streamEvents(ChangeEventSourceContext context, P partition, O offsetContext) throws InterruptedException {
        ...
        LOGGER.info("context is {}, partition is {}, offsetContext.offset is {}, offsetContext.sourceInfo is {}, offsetContext.sourceInfoSchema is {}", context, partition.getSourcePartition(), offsetContext.getOffset(), offsetContext.getSourceInfo(),offsetContext.getSourceInfoSchema());
